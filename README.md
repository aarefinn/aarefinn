...
- **Project Coordinator (Prothoma Bangladesh / ProIT Digital, Ongoing):**  
  - Leading ProIT Digital projects as IT partner for Prothoma Bangladesh  
  - Managing multiple client websites (e‑commerce, info sites, funnels)  
  - Coordinating with dev, design, and operations teams from brief to deployment  
...
- **[Whole Sale Icon](https://wholesaleicon.com/):**  
  - Bangladesh‑based wholesale e‑commerce site built under ProIT Digital  
  - Worked on WordPress + WooCommerce setup, catalog structure, and basic optimization  

- **[ZivoLife](https://zivolife.com/):**  
  - International microalgae‑based health product brand website  
  - Contributed to WordPress implementation, page layouts, and content integration  

- **[The Millionaire Mindset](https://themillionairemindset.online/):**  
  - Landing‑style WordPress site focused on training/education funnel  
  - Built full site structure, sections, and responsive layout  

- **[Winning Wholesale](https://winningwholesale.xyz/):**  
  - Niche wholesale WordPress website  
  - Implemented theme customization, product/category structure, and basic SEO  
